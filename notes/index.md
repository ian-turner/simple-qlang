...
| `OpenQASM.hs`            | Entrypoint-driven OpenQASM emitter; imports `QASMAnalysis` and `QASMRender`                                                          |
| `QASMAnalysis.hs`        | CPS analysis helpers: `isTailLoop`, `bodyIsSelfRecursive`, `bodyAllocatesQubits`                                                     |
| `QASMRender.hs`          | OpenQASM rendering types and functions: `Stmt`, `renderProgram`, etc.                                                                |
...
| `PrettyPrint.hs`         | Pretty-printer for `LExp`, `CExp`, `HoistedProgram`, and concrete/abstract syntax trees; used by `--debug`                           |
...
| 11  | OpenQASM emission                                     | `OpenQASM.hs`, `QASMAnalysis.hs`, `QASMRender.hs`                                                         | done (first cut)                                               |
