...
- Implemented: parse, scope resolution, lowering to Lambda IR, CPS conversion,
  recursion checking, closure conversion
- Not yet implemented: defunctionalization, qubit hoisting, tuple/record
  flattening, gate/def classification, OpenQASM emission
